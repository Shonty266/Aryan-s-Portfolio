  ...
  return (
    <div className=" relative " style={{ height: 'calc(100vh - 14rem)'}}>
      <div className="hero flex flex-col items-center text-center px-4 justify-center pt-28 pb-10">
        <h1
          className="intro-text text-3xl font-bold leading-normal cursor-default text-[#263238]"
          ref={(el) => {
        ...
        <h2
          className="intro-text text-md leading-normal mt-2 text-[#263238]"
          ref={(el) => {
        ...
        <Link
          ...
          className="px-2 py-5 hover:bg-[#e6e6e9] duration-500 bottom-0 absolute animate-bounce rounded-full border-[#a0b1ba] border-2"
        >
